...
def main() -> int:
    ...
    payload = {
        ...
        "usdIrr": usd_irr,
        "steel": steel,
        "imeChain": ime.get("imeChain") or previous.get("imeChain") or [],
        "inventories": indicators.get("inventories") or previous.get("inventories"),
        "bfRate": indicators.get("bfRate") or previous.get("bfRate"),
        "billetStocks": indicators.get("billetStocks") or previous.get("billetStocks"),
        "histories": histories,
